...
export const WORKS = [
  {
    ...
    image: 'assets/img/work-01-poppy.svg', width: 1200, height: 1500,
    size: '60 × 75 cm', edition: '15 + 2 AP', year: 'June',
  ...
  },
  {
    ...
    image: 'assets/img/work-02-clematis.svg', width: 1200, height: 1500,
    size: '60 × 75 cm', edition: '15 + 2 AP', year: 'July',
  ...
  },
  {
    ...
    image: 'assets/img/work-03-shadow.svg', width: 1200, height: 1500,
    size: '50 × 62 cm', edition: '8 sets + 1 AP', year: 'August',
  ...
  },
  {
    ...
    image: 'assets/img/work-04-horizon.svg', width: 1500, height: 1000,
    size: '90 × 60 cm', edition: '10 + 2 AP', year: 'June',
  ...
  },
  {
    ...
    image: 'assets/img/work-05-portrait.svg', width: 1200, height: 1500,
    size: '60 × 75 cm', edition: '10 + 2 AP', year: 'May',
  ...
  },
  {
    ...
    image: 'assets/img/work-06-sage.svg', width: 1200, height: 1200,
    size: '50 × 50 cm', edition: '8 sets + 1 AP', year: 'August',
  ...
  },
  {
    ...
    image: 'assets/img/work-07-dusk.svg', width: 1200, height: 1500,
    size: '60 × 75 cm', edition: '10 + 2 AP', year: 'August',
  ...
  },
  {
    ...
    image: 'assets/img/work-08-bloom.svg', width: 1200, height: 1200,
    size: '50 × 50 cm', edition: '15 + 2 AP', year: 'September',
  ...
  },
  {
    ...
    image: 'assets/img/work-09-shadowwall.svg', width: 1500, height: 1000,
    size: '90 × 60 cm', edition: '8 sets + 1 AP', year: 'August',
  ...
  },
  {
    ...
    image: 'assets/img/work-10-coast.svg', width: 1200, height: 1500,
    size: '60 × 75 cm', edition: '10 + 2 AP', year: 'July',
  ...
  },
  {
    ...
    image: 'assets/img/work-11-clematis.svg', width: 1200, height: 1200,
    size: '50 × 50 cm', edition: '15 + 2 AP', year: 'July',
  ...
  },
  {
    ...
    image: 'assets/img/work-12-portrait.svg', width: 1200, height: 1500,
    size: '60 × 75 cm', edition: '10 + 2 AP', year: 'March',
...
/** A gallery card. `href` defaults to the work's own page. */
export const workCard = (work, { href, reveal = true } = {}) => {
  const series = SERIES[work.series];
  return `        <a class="work" href="${href || `work-${work.slug}.html`}" data-series="${work.series}"${reveal ? ' data-reveal' : ''} data-lightbox-open="${work.image}" data-caption="${work.title} — archival pigment print, ${work.size}">
          <span class="work__media"><img src="${work.image}" alt="${work.alt}" width="${work.width}" height="${work.height}" loading="lazy" decoding="async"></span>
          <span class="work__caption"><span class="work__title">${work.title}</span><span class="work__meta">${series.label}</span></span>
        </a>`;
};
